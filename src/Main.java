...
//        File[] dir = new File("/home/catalina/Desktop/FACULTATE/APD/TEME/TEMA2/tema2/checker/in" + File.separator + test.inFolder).listFiles();
        if (dir != null) {
            for (File input : dir) {
...
//            String output = new Scanner(new File("/home/catalina/Desktop/FACULTATE/APD/TEME/TEMA2/tema2/checker/in" + File.separator + test.inFolder + File.separator + "out")).useDelimiter("\\Z").next();
